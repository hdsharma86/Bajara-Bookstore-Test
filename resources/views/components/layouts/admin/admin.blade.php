    ...
    <main class="bg-white-300">
        <div class="navbar bg-gray-800 sticky top-0 z-50 h-2">
            <div class="flex-1 hidden lg:block">
                <a wire:navigate href="/livewire-admin/dashboard" class="text-white text-xl">
                    Bajara Bookstore Admin
                </a>
            </div>
            ...
            <div class="flex-none">
                <ul class="menu menu-horizontal px-1">
                    ...
                    <li class="ml-3">
                        <a class="text-white" wire:navigate href="/livewire-admin/admin-logout">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <!-- Content Area -->
        <div class="lg:ml-36">
            <div class="py-1 px-4 border-2 border-solid m-2 rounded-box min-h-screen">
                {{ $slot }}
            </div>
        </div>
    </main>
