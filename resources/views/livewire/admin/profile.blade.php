<div>
    ...
    <form wire:submit.prevent="updateProfile()" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="mb-4">
            ...
            <input disabled="true" wire:model='email' class="@error('email') border-red-500 @else border-gray-700 @enderror border rounded w-full py-2 px-3 text-gray-700 disabled:bg-slate-200" id="username" type="text" placeholder="Email">
        ...
        <div class="flex items-center justify-end">
            <button wire:click='cancelProfile()' class="btn btn-outline btn-sm font-bold py-2 px-4 rounded">Cancel</button>
