<div>
    ...
    <form wire:submit.prevent="updateUser()" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div class="mb-4">
        ...
        <div class="flex items-center justify-end">
            <button wire:click='cancelUpdateUser()' class="btn btn-outline btn-sm font-bold py-2 px-4 rounded">Cancel</button>
            <button type="submit" class="btn btn-outline btn-sm font-bold py-2 px-4 rounded ml-3">Update</button>
        </div>
    </form>
</div>
</div>
